...
class ROSInterface
{
  ...
  *********************************************************/
  public:  
    ...
    void TcpSendXstdCallback(const xpkg_msgs::XmsgCommData& data);
    void TcpSendCommonCallback(const std_msgs::ByteMultiArray& data);
    void ComSendXstdCallback(const xpkg_msgs::XmsgCommData& data);
    void ComSendCommonCallback(const std_msgs::ByteMultiArray& data);
  ...
  private: 
    ...
    ros::Publisher pub_com_xstd[12];
    ros::Publisher pub_tcp_xstd[12];
