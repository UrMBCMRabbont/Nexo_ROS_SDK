...
void ROSInterface::PublisherInit()
{
  ...
  {
      pub_com_xstd[0] = m_node_local_ptr->advertise<xpkg_msgs::XmsgCommData>("/xtopic_comm/com_recv_xstd_vehicle", 50);
      pub_com_xstd[1] = m_node_local_ptr->advertise<xpkg_msgs::XmsgCommData>("/xtopic_comm/com_recv_xstd_arm", 50);
      pub_com_xstd[2] = m_node_local_ptr->advertise<xpkg_msgs::XmsgCommData>("/xtopic_comm/com_recv_xstd_conveyer", 50);
      pub_com_xstd[3] = m_node_local_ptr->advertise<xpkg_msgs::XmsgCommData>("/xtopic_comm/com_recv_xstd_light", 50);
      pub_com_xstd[4] = m_node_local_ptr->advertise<xpkg_msgs::XmsgCommData>("/xtopic_comm/com_recv_xstd_driver", 50);
      pub_com_xstd[5] = m_node_local_ptr->advertise<xpkg_msgs::XmsgCommData>("/xtopic_comm/com_recv_xstd_power", 50);
      pub_com_xstd[6] = m_node_local_ptr->advertise<xpkg_msgs::XmsgCommData>("/xtopic_comm/com_recv_xstd_comm", 50);
      pub_com_xstd[7] = m_node_local_ptr->advertise<xpkg_msgs::XmsgCommData>("/xtopic_comm/com_recv_xstd_sensor_dist", 50);
      pub_com_xstd[8] = m_node_local_ptr->advertise<xpkg_msgs::XmsgCommData>("/xtopic_comm/com_recv_xstd_sensor_line", 50);
      pub_com_xstd[9] = m_node_local_ptr->advertise<xpkg_msgs::XmsgCommData>("/xtopic_comm/com_recv_xstd_switch", 50);
      pub_com_xstd[10] = m_node_local_ptr->advertise<xpkg_msgs::XmsgCommData>("/xtopic_comm/com_recv_xstd_sensor_imu", 50);
      pub_com_xstd[11] = m_node_local_ptr->advertise<xpkg_msgs::XmsgCommData>("/xtopic_comm/com_recv_xstd_sensor_gps", 50);
  }
  ...
  {
      pub_tcp_xstd[0] = m_node_local_ptr->advertise<xpkg_msgs::XmsgCommData>("/xtopic_comm/tcp_recv_xstd_vehicle", 50);
      pub_tcp_xstd[1] = m_node_local_ptr->advertise<xpkg_msgs::XmsgCommData>("/xtopic_comm/tcp_recv_xstd_arm", 50);
      pub_tcp_xstd[2] = m_node_local_ptr->advertise<xpkg_msgs::XmsgCommData>("/xtopic_comm/tcp_recv_xstd_conveyer", 50);
      pub_tcp_xstd[3] = m_node_local_ptr->advertise<xpkg_msgs::XmsgCommData>("/xtopic_comm/tcp_recv_xstd_light", 50);
      pub_tcp_xstd[4] = m_node_local_ptr->advertise<xpkg_msgs::XmsgCommData>("/xtopic_comm/tcp_recv_xstd_driver", 50);
      pub_tcp_xstd[5] = m_node_local_ptr->advertise<xpkg_msgs::XmsgCommData>("/xtopic_comm/tcp_recv_xstd_power", 50);
      pub_tcp_xstd[6] = m_node_local_ptr->advertise<xpkg_msgs::XmsgCommData>("/xtopic_comm/tcp_recv_xstd_comm", 50);
      pub_tcp_xstd[7] = m_node_local_ptr->advertise<xpkg_msgs::XmsgCommData>("/xtopic_comm/tcp_recv_xstd_sensor_dist", 50);
      pub_tcp_xstd[8] = m_node_local_ptr->advertise<xpkg_msgs::XmsgCommData>("/xtopic_comm/tcp_recv_xstd_sensor_line", 50);
      pub_tcp_xstd[9] = m_node_local_ptr->advertise<xpkg_msgs::XmsgCommData>("/xtopic_comm/tcp_recv_xstd_switch", 50);
      pub_tcp_xstd[10] = m_node_local_ptr->advertise<xpkg_msgs::XmsgCommData>("/xtopic_comm/tcp_recv_xstd_sensor_imu", 50);
      pub_tcp_xstd[11] = m_node_local_ptr->advertise<xpkg_msgs::XmsgCommData>("/xtopic_comm/tcp_recv_xstd_sensor_gps", 50);
...
void ROSInterface::PubTcpXstd(const XstdData& data)
{
    ...
    pub_tcp_xstd[data.id_c-1].publish(data_tcp);
}
/*------------------------------------------------------------------------------------------------------------------
 * name: PubComCommon
 -----------------------------------------------------------------------------------------------------------------*/
...
void ROSInterface::PubComXstd(const XstdData& data)
{
    ...
    pub_com_xstd[data.id_c-1].publish(data_com);
}
/*------------------------------------------------------------------------------------------------------------------
 * name: PubDevList
 -----------------------------------------------------------------------------------------------------------------*/
 ...
 * name: sub callback
 -----------------------------------------------------------------------------------------------------------------*/
void ROSInterface::TcpSendXstdCallback(const xpkg_msgs::XmsgCommData& data)
{
  m_f_tcp_xstd = true;
  XstdData data_tcp;
  data_tcp.len = data.len;
...
///////////////////////////////////////////////////////////////////////////////////////////////
void ROSInterface::TcpSendCommonCallback(const std_msgs::ByteMultiArray& data)
{
  m_f_tcp_common = true;
...
///////////////////////////////////////////////////////////////////////////////////////////////
void ROSInterface::ComSendXstdCallback(const xpkg_msgs::XmsgCommData& data)
{
  m_f_com_xstd = true;
  XstdData data_com;
  data_com.len = data.len;
...
///////////////////////////////////////////////////////////////////////////////////////////////
void ROSInterface::ComSendCommonCallback(const std_msgs::ByteMultiArray& data)
{
  m_f_com_common = true;
