...
public:
    ...
    void CalcWithSpeed(double v_x,double v_y,double v_r,double time_now,unsigned char rotate_mode);
    void CalcWithOdom(double odom_l,double odom_r,double odom_l_s,double odom_r_s,double time_now,unsigned char rotate_mode);
